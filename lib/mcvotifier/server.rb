  ...
  class Server
    ...
    def initialize(*args)
      if args.size == 1 && args[0].respond_to?(:hostname) && args[0].respond_to?(:port) && args[0].respond_to?(:private_decrypt)
        ...
        @minecraft_server = MCVotifier::MinecraftServer.new(args[0])
      elsif args.size == 2
        @minecraft_server = MCVotifier::MinecraftServer.new(args[0], args[1])
      elsif args.size == 3
        @minecraft_server = MCVotifier::MinecraftServer.new(args[0], args[1], args[2])
      else
